...
event5 = Event.create!(user: users.sample, name:'Pole dance 1ª time', location:'Rua do Moreira, 4000-347 Porto', category:'Experiences', date:Faker::Date.between(from: '2021-09-12', to: '2021-12-25'), description:'Just a fancy sexy dance', price: 15, max_people:3)
event6 = Event.create!(user: users.sample, name:'Rock in Rio', location:'Av. Dr. Arlindo Vicente, Lisboa', category:'Events', date:Faker::Date.between(from: '2021-09-12', to: '2021-12-25'), description:'rock \'n\' roll o\'clock ', price: 80, max_people: 10)
...
event9 = Event.create!(user: users.sample, name:'Climbing', location:'Rua de Angola, 2620-036 Olival Basto', category:'Sports', date:Faker::Date.between(from: '2021-09-12', to: '2021-12-25'), description:'As someone said  is natural to human beings. We walk, run and climb', price: 10, max_people:2)
...
event11 = Event.create!(user: users.sample, name:'Fancy Dinner', location:'Av. Marginal 0, 2775-604 Carcavelos', category:'Gastronomy', date:Faker::Date.between(from: '2021-09-12', to: '2021-12-25'), description:'A dinner like monaco but in Oeiras', price:40, max_people:3)
event12 = Event.create!(user: users.sample, name:'Felling Lonely :(', location:'R. da Rosa, 1200-385 Lisboa', category:'Meet', date:Faker::Date.between(from: '2021-09-12', to: '2021-12-25'), description:'just a boy looking for some fun ', price:15, max_people:2)
...
event17 = Event.create!(user: users.sample, name:'Algarve holidays', location:'Av. Francisco Sá Carneiro, 8125-141 Quarteira', category:'Travel', date:Faker::Date.between(from: '2021-09-12', to: '2021-12-25'), description:'Sun, Avencs and Camones', price:70, max_people:8)
event18 = Event.create!(user: users.sample, name:'Sky dive', location:'N254, 7005-797 Évora', category:'Experiences', date:Faker::Date.between(from: '2021-09-12', to: '2021-12-25'), description:'May the gravity be with you', price:100, max_people: 1)
