...
event5 = Event.create!(user: users.sample, name:'Pole dance 1ª time', location:'R. Moreira, 4000-347 Porto', category:'Experiences', date:Faker::Date.between(from: '2021-09-12', to: '2021-12-25'), description:'Just a fancy sexy dance', price: 15, max_people:3)
...
event9 = Event.create!(user: users.sample, name:'Climbing', location:'Edifício Lobo Rua Angola, 2620-036 Olival Basto', category:'Sports', date:Faker::Date.between(from: '2021-09-12', to: '2021-12-25'), description:'As someone said  is natural to human beings. We walk, run and climb', price: 10, max_people:2)
